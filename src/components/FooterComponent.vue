...
footer {
    background-color: $colorBlueDarken4;
    display: flex;
...
.contenedor-icono {
    ...
    a {
        ...
        box-shadow: 0px 0px 10px 0px $colorBlancoRelax;
        border-radius: 50%;
        padding: .5rem;
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: center;
        background-color: $colorBlancoRelax;
    ...
    &:hover {
        /* transform: rotate(0.5turn);
        transition: 1s; */
        animation: identifier alternate 1s ease-in-out 1s infinite;
    }
}
